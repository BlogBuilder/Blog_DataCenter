    ...
    <div class="page-container">
        ...
        <div class="header light bg-white ">
            ...
            <div class="d-flex align-items-center">
                                            ...
                                            <div class="heading">
                                                <div class="thumbnail-wrapper d24 circular b-white m-r-5 b-a b-white m-t-10 m-r-10">
                                                    <img width="30" height="30"
                                                         data-src-retina="./assets/images/profiles/1.jpg"
                                                         data-src="./assets/images/profiles/1.jpg" alt=""
              ...
              <img src="../assets/images/profiles/avatar.jpg" alt="" data-src="../assets/images/profiles/avatar.jpg"
                   data-src-retina="../assets/images/profiles/avatar_small2x.jpg" width="32" height="32">
              </span>
                    </button>
